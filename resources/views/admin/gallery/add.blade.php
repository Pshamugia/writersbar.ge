...
@section('menu')
    ...
    <form action="{{ route('admin.gallery.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label>სათაური</label>
            <input type="text" name="title" class="form-control" aria-describedby="emailHelp" placeholder="სათაური">
        </div>

        <div class="form-group">
            <label>saTavo suraTi</label>
        ...
        <div class="form-group">
            ...
            <input type="date" name="year" class="form-control" aria-describedby="emailHelp"
